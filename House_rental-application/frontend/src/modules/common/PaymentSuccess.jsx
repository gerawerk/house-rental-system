...
const PaymentSuccess = () => {
  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', padding: '40px 20px', background: 'var(--bg-secondary)', borderRadius: 16, boxShadow: '0 4px 12px rgba(0,0,0,0.05)', maxWidth: 500, margin: '20px' }}>
        {status === 'verifying' && (
          <>
            <Spin size="large" />
            <h3 style={{ marginTop: 24, color: 'var(--text-main)' }}>Verifying your payment...</h3>
        ...
        {status === 'failed' && (
          <>
            ...
            <h2 style={{ color: 'var(--text-main)', marginBottom: 8 }}>Payment Verification Failed</h2>
